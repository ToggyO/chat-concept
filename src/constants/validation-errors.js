...
export const VALIDATION_ERRORS = {
  ...
  invalidDateFormat: ({ field, minDate, maxDate }) => ({
    ...
    errorMessage: `Incorrect date format${minDate ? `. Minimum date threshold exceeded - ${minDate}.` : ''}${maxDate ? `. The maximum date threshold has been exceeded - ${maxDate}.` : ''}`, // eslint-disable-line
  }),
